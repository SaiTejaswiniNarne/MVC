...
namespace WebApplication4.Controllers
{
    public class DegreeRequirementsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.DegreeRequirement.Include(d => d.Degree);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var degreeRequirement = await _context.DegreeRequirement
                .Include(d => d.Degree)
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var degreeRequirement = await _context.DegreeRequirement.FindAsync(id);
            if (degreeRequirement == null)
            {
                return NotFound();
            }
        ...
        {
            var degreeRequirement = await _context.DegreeRequirement.FindAsync(id);
            _context.DegreeRequirement.Remove(degreeRequirement);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.DegreeRequirement.Any(e => e.DegreeRequirementId == id);
        }
    }
}
